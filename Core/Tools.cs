...
namespace True_Mining_Desktop.Core
{
    public class Tools
    {
        public static bool IsConnected()
        {
            ...
            try
            {
                if (Tools.HttpGet("https://truemining.online/ping") == "pong") { return true; }
            }
            catch { }

            try
            {
                if (Tools.HttpGet("http://truemining.online/ping") == "pong") { return true; }
            }
            catch { }

            try
            {
                if (Tools.HttpGet("https://www.utivirtual.com.br/Truemining/ping") == "pong") { return true; }
            }
            catch { }
